...
//        'create' => 'Create',
    ...
    protected function grid()
    {
        ...
        $grid->column('unique_no', __('Unique no'))->width(200)->modal('素材信息', RecordMaterial::class);
        ...
        $grid->column('episodes', __('Episodes'))->display(function ($episode) {
            if ($this->expired_date) {
                ...
                return "$episode <span title=\"过期日期\" class=\"label\">$s</span>";
            }else 
            {
                return $episode;
            } 
        ...
        $grid->column('expired_date', __('Expired date'))->substr(0,10)->hide();
