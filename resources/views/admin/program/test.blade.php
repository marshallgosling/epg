<div class="row">
<form id="widget-form-655477f1c8f59" method="POST" action="/admin/channel/test/data/{{$model->id}}/save" class="form-horizontal" accept-charset="UTF-8" pjax-container="1">
    ...
    $(function () {
        ...
        $('#btnSort').on('click', function(e) {
            if($('#btnSort').html() != '保存') {
                ...
                $.ajax({
                    method: 'post',
                    url: '/admin/channel/test/data/{!! $model->id !!}/save',
                    data: {
